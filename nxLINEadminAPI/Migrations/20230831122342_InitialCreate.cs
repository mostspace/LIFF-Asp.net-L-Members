        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    member_zipcode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    member_pref = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    member_address = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    member_tel = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    member_fax = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    member_mobile = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    member_email = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    member_gender = table.Column<byte>(type: "tinyint", nullable: false),
                    ...
                    member_rank = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    member_note = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    member_tag = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    member_nonce = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    member_lineid = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    member_stripeId = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    member_password_hash = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    member_password_salt = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    member_email_verify_token = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    member_email_verify_expired_at = table.Column<DateTime>(type: "datetime2", nullable: true),
                    member_password_reset_token = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    member_pending_email = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    member_pending_email_verify_token = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    member_is_signup_verified = table.Column<bool>(type: "bit", nullable: false),
                    member_signup_verify_token = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    member_searchtext = table.Column<string>(type: "nvarchar(max)", nullable: false),
